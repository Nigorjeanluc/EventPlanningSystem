...
<body style="background-color:lightskyblue;">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown font">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="active font"><a href="hotels.php">Hotels</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800" class="page-header text-center">Hotels<span id="kbs" class="text-muted"></span>
                </h1>
                <ol class="breadcrumb">
                    <li class="active"><a>Hotels</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                            <?php
                                include("connect.php");
                                $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND (Event='Venue' AND Categorie='Hotel') ORDER BY ID DESC LIMIT 0,3");
