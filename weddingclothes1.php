...
<body style="background-color:lightskyblue;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800;margin-top:90px" class="page-header text-center">Civil Wedding
                    <small>Facilities</small><span id="kbs" class="text-muted"></span>
                </h1>
                
                <p style="margin-bottom:8px" class="text-center"><a href="weddingclothes.php" class="btn btn-primary">Normal Wedding's items</a></p>
                ...
                <div style="background:none" class="row">
                    ...
                    <?php
                            ...
                            if(isset($_REQUEST['nonono'])){
                                if($_REQUEST['nonono']==1){
                                    ...
                                    $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Wedding&clothes' AND Categorie='Shoes' AND Sex='Female' AND Types='Civil' ORDER BY ID DESC LIMIT 0,6");
                                    ...
                                    $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Wedding&clothes' AND Categorie='Dress' AND Sex='Female' AND Types='Civil' ORDER BY ID DESC LIMIT 0,6");
                                    while($myrow = mysqli_fetch_array($pipsql)){
                                        echo'
                                    <div class="col-md-4">
                                        <div class="panel panel-default text-center">
                                ...
                                echo'<h2 style="font-family:cursive" class="text-center">Shoes</h2><hr><div class="row">';
                                    $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Wedding&clothes' AND Categorie='Shoes' AND Sex='Male' AND Types='Civil' ORDER BY ID DESC LIMIT 0,6");
                                    while($myrow = mysqli_fetch_array($pipsql)){
                                        echo'
                                    <div class="col-md-4">
                                        <div class="panel panel-default text-center">
                                    ...
                                    $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Wedding&clothes' AND Categorie='Suit' AND Sex='Male' AND Types='Civil' ORDER BY ID DESC LIMIT 0,6");
                                    while($myrow = mysqli_fetch_array($pipsql)){
                                        echo'
                                    <div class="col-md-4">
                                        <div class="panel panel-default text-center">
                                    ...
                                    $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Wedding&clothes' AND Categorie='Tie' AND Sex='Male' AND Types='Civil' ORDER BY ID DESC LIMIT 0,6");
                                    while($myrow = mysqli_fetch_array($pipsql)){
                                        echo'
                                    <div class="col-md-4">
                                        <div class="panel panel-default text-center">
                    ...
                    <div class="col-md-12">
                        <nav class="cd-stretchy-nav add-content">
                            ...
                            <ul>
                                <li><a href="weddingclothes1.php"><span>Male</span></a></li>
                                <li><a href="weddingclothes1.php?nonono=1"><span>Female</span></a></li>
