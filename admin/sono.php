    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Sonorisation</h1>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading text-center">
                                        All kinds of sono services
                                    </div>
                                    <!-- /.panel-heading -->
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            include("../connect.php");
                                            $sqli="SELECT * FROM service WHERE Event='Sono' ORDER BY ID DESC";
                            ...
                            <div class="col-lg-6">
                                <div id="here" class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        if($yes){
                                            ...
                                            <div class="alert alert-success alert-dismissable">
                                                ...
                                                Devices added <a href="#" class="alert-link">More Details</a>.
                                            </div>
                                            ';
                                        }
                                        ?>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label>List all available devices</label>
                                                    <div class="input-group">
                                                    <input id="G" type="text" class="form-control" placeholder="Device name here!">
                                    ...
                                    <div class="panel-footer text-center">
                                        <button id="kbs" type="submit" name="yeahhhh" class="btn btn-primary">Add new sono</button>
                                    </div>
                                </form>
                                    <!--</div>-->
                                    <!-- /.panel-body -->
