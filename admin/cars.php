    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Cars</h1>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                                    ...
                                                                    <?php
                                                                        include("../connect.php");
                                                                        $sqli="SELECT * FROM service WHERE Event='Car' ORDER BY ID DESC";
                            ...
                            <div class="col-lg-6">
                                <div id="here" class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        echo'
                                                        <div class="alert alert-success alert-dismissable">
                                                            ...
                                                            Car added <a href="#" class="alert-link">More Details</a>.
                                                        </div>
                                                        ';
                                            }
                                        ?>
                                        ...
                                        <div class="form-group">
                                            <label>Name of the company or the car owner</label>
                                            <input class="form-control" type="text" name="company" placeholder="Enter the owner of the car" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Mark of the car -- Immatriculation number:</label>
                                            <input class="form-control" type="text" name="item" placeholder="Example: Toyota Carina E -- RAB667W" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Price</label>
                                    ...
                                    <div class="panel-footer text-center">
                                        <button type="submit" name="yeahh" class="btn btn-primary">Add the car</button>
                                    </div>
                                </form>
                                    <!--</div>-->
                                    <!-- /.panel-body -->
