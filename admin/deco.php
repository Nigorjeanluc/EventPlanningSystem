    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Decoration</h1>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading text-center">
                                        All kinds of decoration services
                                    </div>
                                    <!-- /.panel-heading -->
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            include("../connect.php");
                                            $sqli="SELECT * FROM service WHERE Event='Deco' ORDER BY ID DESC";
                                ...
                                <div id="here" class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label>List all available services</label>
                                    ...
                                    <div class="panel-footer text-center">
                                        <button id="kbs" type="submit" name="yeahhhhh" class="btn btn-primary">Add new decoration service</button>
                                    </div>
                                </form>
                                    <!--</div>-->
                                    <!-- /.panel-body -->
