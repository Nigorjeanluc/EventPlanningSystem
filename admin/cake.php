    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Cakes</h1>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            include("../connect.php");
                                            $sqli="SELECT * FROM service WHERE Event='Cake' ORDER BY ID DESC";
                                ...
                                <div id="here" class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label>List all used ingredients</label>
                                    ...
                                    <div class="panel-footer text-center">
                                        <button id="kbs" type="submit" name="yeahhhhhh" class="btn btn-primary">Add new cake</button>
                                    </div>
                                </form>
                                    <!--</div>-->
                                    <!-- /.panel-body -->
