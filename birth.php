...
<body style="background-color:lightskyblue;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active font"><a href="birth.php">Parties & Birthdays Events</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800" class="page-header text-center">Formal Parties & Birthdays
                    <small>Facilities</small><span id="kbs" class="text-muted"></span>
                </h1>
                <ol class="breadcrumb">
                    <li><a>Parties & Birthdays</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group text-center">
                    <a href="birth.php" class="list-group-item active">Cakes</a>
            ...
            <div class="col-md-9">
                <div class="row">
                            <?php
                                include("connect.php");
                                $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Cake' ORDER BY ID DESC LIMIT 0,3");
