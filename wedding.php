        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="wedding1.php">Civil wedding event</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                            <?php
                                include("connect.php");
                                $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND (Event='Wedding&clothes' AND Types='Wedding') ORDER BY ID DESC LIMIT 0,3");
                                ...
                                <div class="col-md-4">
                                    <div class="panel panel-default text-center">
                                        ...
                                        <div align="center"><div align="center"><img style="position:relative;height:200px;" class="img-responsive" src="'.$myrow['picone'].'"></div></div>
