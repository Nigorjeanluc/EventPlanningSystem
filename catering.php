...
<body style="background-color:lightskyblue;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active font"><a href="catering.php">Outside Catering</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800" class="page-header text-center">Outside Catering
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group text-center">
                    ...
                    <a href="catering.php" class="list-group-item active">Catering</a>
            ...
            <div class="col-md-9">
                <div class="row">
                            <?php
                                include("connect.php");
                                $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Catering' ORDER BY ID DESC LIMIT 0,3");
