  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method="post" action="../opera/loginadmin.php">
        <h4 class="form-signin-heading text-center">Sign in as a Company Owner</h4>
        <?php
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="pooo">Sign in</button>
      </form>
