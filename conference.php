...
<body style="background-color:lightskyblue;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active font"><a href="conference.php">Conferences</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800" class="page-header text-center">Conference Events
                    <small>Facilities</small><span id="kbs" class="text-muted"></span>
                </h1>
                <ol class="breadcrumb">
                    <li class="active"><a>Catering</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group text-center">
                    <a href="conference.php" class="list-group-item active">Rooms/Salles</a>
            ...
            <div class="col-md-9">
                <div class="row">
                            <?php
                                include("connect.php");
                                $pipsql = mysqli_query($dbcon,"SELECT * FROM service WHERE Available= 1 AND Event='Venue' ORDER BY ID DESC LIMIT 0,3");
                                while($myrow = mysqli_fetch_array($pipsql)){
                                    echo'
                                <div class="col-md-4">
                                    <div class="panel panel-default text-center">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">'.$myrow['CompanyName'].'</h3>
                                        </div>
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><strong>More:</strong> '.$myrow['Name'].'</li>
