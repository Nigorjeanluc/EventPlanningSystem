...
<body style="background-color:lightskyblue;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-family:cursive;font-weight:800" class="page-header text-center">Cars
                    <small>Available</small><span id="kbs" class="text-muted"></span>
                </h1>
                <ol class="breadcrumb">
                    <li class="active"><a>Cars</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group text-center">
                    ...
                    <a href="weddingcars.php" class="list-group-item active">Cars</a>
